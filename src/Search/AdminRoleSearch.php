...
use Oyhdd\Admin\Model\{AdminRole, AdminPermission};
    ...
    public function searchForm(array $params = [], bool $expand = false): Form
    {
        ...
        $form->row(function() use ($form, $params) {
            return [
                ...
                $form->column(6, $form->multipleSelect('permissions.id', '权限')
                    ->options(
                        AdminPermission::all()->pluck('name', 'id')->toArray(),
