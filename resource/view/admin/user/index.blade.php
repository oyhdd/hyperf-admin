...
<form method="get">
    <div class="input-group row">
        ...
        <select class="form-control select2 col-sm-3" name="push_type">
        ...
        <button type="submit" class="btn btn-primary float-right ml-2">搜索</button>
        <a class='btn btn-success float-right ml-2' href="/admin/message/create">创建</a>
    </div>
</form>
@endsection
...
@include('common.table', [
    ...
    'columns' => [
        ...
        [
            'label' => '推送状态',
            'value' => function ($model) {
                return $model::$state_label[$model->state] ?? '';
            }
        ],
        [
            'label' => '操作人',
