...
<head>
    ...
    <link rel="stylesheet" href="/vendor/hyperf-admin/AdminLTE/dist/css/google-font/fonts.css">
    <!-- SweetAlert2 -->
...
<div class="lockscreen-wrapper" id="lockscreen_wrapper" style="margin-top: 20.5rem;">
    <div class="lockscreen-item" style="width: 60px;">
        <div class="lockscreen-image" style="margin-top: -70px;">
            <img src="{{ empty($data['_user']['avatar']) ? config('admin.default_avatar') : $data['_user']['avatar'] }}" alt="{{ $data['_user']['name'] ?? 'User Image' }}">
        </div>
    </div>
    <!-- User name -->
