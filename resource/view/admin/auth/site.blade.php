<?php
    ...
    $form->select('color_scheme')->options($model::$colorScheme, [$model->color_scheme]);
    $form->select('animation_type')->options($model::$animationType, [$model->animation_type])->help('see more: <a href="https://daneden.github.io/animate.css/">https://daneden.github.io/animate.css/</a>');
